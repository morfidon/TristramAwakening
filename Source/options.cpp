...
GameplayOptions::GameplayOptions()
    ...
    , autoSaveEnabled("Auto Save", OptionEntryFlags::CantChangeInMultiPlayer, N_("Auto Save"), N_("Automatically save the game periodically and after key single-player events when it is safe to do so."), true)
